...
function valid()
{
	...
	var fil=document.getElementById("content").files[0];
...
<form:form method="post" onsubmit="return valid();" action="upload" modelAttribute="teacherresource" enctype="multipart/form-data">
